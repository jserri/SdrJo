#pragma once
//
// Tabelle di protocollo FT8 (codice LDPC 174,91).
//
// Queste sono COSTANTI DEL PROTOCOLLO FT8, fissate dalla specifica del
// modo (le stesse valori si trovano identici in ft8_lib, licenza MIT, e
// in WSJT-X): la matrice generatrice LDPC e la connettivita' dei nodi di
// parita'. Non sono espressione creativa ma dati dettati dallo standard;
// gli algoritmi che le usano (CRC, LDPC, sincronizzazione, demod,
// impacchettamento) sono scritti da zero per SdrJo.
//
// Generate automaticamente dalle tabelle di riferimento; non modificare a
// mano.
//
#include <cstdint>
...
// 83 righe del generatore, ciascuna 91 bit impacchettati in 23 cifre hex
// (i primi 91 bit dei 92; l'ultimo bit e' scartato).
inline const char* const kGeneratorHex[83] = {
...
// Per ciascuno degli 83 controlli di parita': fino a 7 indici di bit
// (1-based, come in WSJT-X). Le colonne oltre kNrw[i] non sono valide.
inline const int16_t kNm[83][7] = {
...
// Peso (numero di bit) di ciascun controllo di parita'.
inline const int8_t kNrw[83] = {
    7, 6, 6, 6, 7, 6, 7, 6, 6, 7, 6, 6, 7, 7, 6, 6, 6, 7, 6, 7, 6, 7, 6, 6, 6, 7, 6, 6, 6, 7, 6, 6, 6, 6, 7, 6, 6, 6, 7, 7, 6, 6, 6, 6, 7, 7, 6, 6, 6, 6, 7, 6, 6, 6, 7, 6, 6, 6, 6, 7, 6, 6, 6, 7, 6, 6, 6, 7, 7, 6, 6, 7, 6, 6, 6, 6, 6, 6, 6, 7, 6, 6, 6
};
