...
bool FrequencyStore::load(const std::string& path)
{
    ...
    while (std::fgets(line, sizeof(line), f)) {
        ...
        ff.bandwidthHz = std::atof(s.substr(p3 + 1).c_str());
